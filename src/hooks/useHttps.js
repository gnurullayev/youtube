...
const useHttp = () => {
  ...
  const request6 = async (id) => {
    try {
      const options = {
        ...
        headers: {
          'X-RapidAPI-Key': 'a8a48071ddmsh34dacd5862bd12dp1239a9jsn26d84333edba',
          'X-RapidAPI-Host': 'youtube-v31.p.rapidapi.com'
        }
      };
      const res = await axios.request(options)
  ...
  return {request,request1,request2,request3, request4,request5,request6}
}
...
const options = {
  ...
  url: 'https://youtube-v31.p.rapidapi.com/search',
  params: {
    channelId: 'UCrE2_Dpc0d2e8f8VTiRRXFw',
    part: 'snippet,id',
    order: 'date',
    maxResults: '50'
  },
